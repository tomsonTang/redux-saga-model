...
function sagaModelManagerFactory(createOpts) {
  var _createOpts$initialSt = createOpts.initialState,
      initialState = _createOpts$initialSt === undefined ? {} : _createOpts$initialSt,
      _createOpts$initialRe = createOpts.initialReducer,
      initialReducer = _createOpts$initialRe === undefined ? {} : _createOpts$initialRe,
      _createOpts$initialMi = createOpts.initialMiddleware,
      initialMiddleware = _createOpts$initialMi === undefined ? [] : _createOpts$initialMi,
      _createOpts$initialMo = createOpts.initialModles,
      initialModles = _createOpts$initialMo === undefined ? [] : _createOpts$initialMo;
