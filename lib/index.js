...
var SagaModelManager = exports.SagaModelManager = function () {
  function SagaModelManager() {
    ...
    (0, _classCallCheck3.default)(this, SagaModelManager);
  ...
  (0, _createClass3.default)(SagaModelManager, [{
    key: "filterModels",
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return saga.apply(undefined, (0, _toConsumableArray3.default)(args.concat(this.createEffects(model))));
