...
exports.SagaModelManager = undefined;
...
var SagaModelManager = exports.SagaModelManager = function () {
  function SagaModelManager() {
    var createOpts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, SagaModelManager);
    ...
    installPrivateProperties[this.__sagaModelKey] = _extends({}, opts, {
  ...
  _createClass(SagaModelManager, [{
    ...
    value: function filterModels(models, baseModels) {
      ...
      return models.filter(function (m) {
        var ret = void 0;
        try {
          ret = _this.checkModel(m, baseModels);
        } catch (error) {
    ...
    key: "checkModel",
    value: function checkModel(m, baseModels) {
      ...
      (0, _invariant2.default)(!baseModels.some(function (model) {
        return model.namespace === namespace;
      }), "modelManager.model: namespace should be unique");
      (0, _invariant2.default)(!model.subscriptions || (0, _isPlainObject2.default)(model.subscriptions), "modelManager.model: subscriptions should be Object");
    ...
    key: "getReducer",
    value: function getReducer(reducers, state) {
    ...
    value: function createDispatch(dispatch, model) {
      ...
      return function (action) {
        ...
        return dispatch(_extends({}, action, {
          type: _this3.prefixType(type, model)
        }));
      };
    }
    ...
    value: function getWatcher(key, _saga, model, onError) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return saga.apply(undefined, _toConsumableArray(args.concat(this.createEffects(model))));
      ...
      // 将每个 saga 进行 AOP 封装
      var sagaWithOnEffect = this.applyOnEffect(onSaga, sagaWithCatch, model, key);
    ...
    key: "applyOnEffect",
    value: function applyOnEffect(fns, saga, model, key) {
    ...
    value: function store() {
      ...
      var reducers = _extends({}, privateProps.initialReducer);
      ...
      try {
        for (var _iterator3 = privateProps.models[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var m = _step3.value;
      ...
      var middlewares = [].concat(_toConsumableArray(privateProps.initialMiddleware), [sagaMiddleware], _toConsumableArray((0, _flatten2.default)(extraMiddlewares)));
      ...
      // eslint-disable-line
      createReducer(), privateProps.initialState, _redux.compose.apply(undefined, _toConsumableArray(enhancers)));
      ...
      try {
        for (var _iterator5 = this._models[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
exports.default = new SagaModelManager();